...
export var GroupedListV2FC = function (props) {
    ...
    var renderHeader = function (item, flattenedIndex) {
        ...
        var headerProps = __assign(__assign(__assign({}, groupProps.headerProps), getDividerProps(item.group, flattenedIndex)), { key: group.key, groupedListId: item.groupId, ariaLevel: group.level ? group.level + 1 : 1, ariaSetSize: groups ? groups.length : undefined, ariaPosInSet: flattenedIndex !== undefined ? flattenedIndex + 1 : undefined });
    ...
    var renderItem = function (item, flattenedIndex) {
        ...
        if (item.type === 'header') {
            ...
            return onRenderCell(level, item.item, (_a = item.itemIndex) !== null && _a !== void 0 ? _a : flattenedIndex);
        }
    };
...
var GroupedListV2Wrapper = /** @class */ (function (_super) {
    ...
    GroupedListV2Wrapper.getDerivedStateFromProps = function (nextProps, previousState) {
        ...
        if (groups !== previousState.groups) {
            return __assign(__assign({}, previousState), { groups: groups });
        }
